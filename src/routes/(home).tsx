		...
		<div class="grid grid-cols-1 gap-8">
				...
				<div class="z-1 col-span-2 flex w-full flex-col justify-between gap-10 rounded-xl border-2 border-dashed border-slate-900 bg-transparent p-6 dark:border-gray-300 sm:flex-row">
					<div class="prose prose-invert w-full rounded-lg border-2 bg-slate-900 p-4">
						...
						<ul>
							...
							<li>
								Learning about economics, various programming
								languages's and complex interfaces
							</li>
							<li>Optimizing my iteration cycles</li>
							<li>
								This website, current state: <b>WIP</b> (missing
								a Did and Blog sections){" "}
							</li>
						</ul>
					</div>
					<div class="prose prose-invert w-full rounded-lg border-2 bg-slate-900 p-4">
						<h3 class="text-yellow  justify-center font-bold">
							About me:
						</h3>
						<ul>
			...
			>
				<GridItem path={"/read"}>
					...
					Books and articles that I found interesting and/or learned
					something from and would like to share
				</GridItem>
          ...
          the same list)
				...
				<GridItem path={"/study"}>
					...
					Repos, books, videos, courses related to computer science,
					enterprise, project management, design or career that I use
					as my guides
				</GridItem>
				<GridItem
